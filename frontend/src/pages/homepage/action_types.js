const homepageActionTypes = {
  ...
  ASK_NICELY_FOR_NOTIFICATION_PERMISSION: Symbol('homepage/ASK_NICELY_FOR_NOTIFICATION_PERMISSION'),
  REQUEST_NOTIFICATION_PERMISSION: Symbol('homepage/REQUEST_NOTIFICATION_PERMISSION'),
  ASK_LATER_FOR_NOTIFICATION_PERMISSION: Symbol('homepage/ASK_LATER_FOR_NOTIFICATION_PERMISSION'),
}
