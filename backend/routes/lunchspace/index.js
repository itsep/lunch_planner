...
const { inviteLunchspaceRoute, inviteLunchspaceLinkRoute } = require('./invite_lunchspace')
...
lunchspaceRouter.post('/invite_link', authenticateRequest, checkLunchspacePermissionOfRequest, getUser, asyncHandler(inviteLunchspaceLinkRoute))
